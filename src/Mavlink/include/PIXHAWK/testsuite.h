...
static void mavlink_test_pixhawk_hg_fast(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PIXHAWK_HG_FAST >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_pixhawk_hg_fast_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PIXHAWK_HG_FAST_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PIXHAWK_HG_FAST_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_pixhawk_hg_med(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PIXHAWK_HG_MED >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_pixhawk_hg_med_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PIXHAWK_HG_MED_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PIXHAWK_HG_MED_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_pixhawk_hg_slow(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PIXHAWK_HG_SLOW >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_pixhawk_hg_slow_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PIXHAWK_HG_SLOW_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_xcsoar_calculated(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_XCSOAR_CALCULATED >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_xcsoar_calculated_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_XCSOAR_CALCULATED_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_XCSOAR_CALCULATED_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
