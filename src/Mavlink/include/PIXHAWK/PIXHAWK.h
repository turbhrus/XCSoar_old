...
#include "./mavlink_msg_pixhawk_hg_fast.h"
#include "./mavlink_msg_pixhawk_hg_med.h"
#include "./mavlink_msg_pixhawk_hg_slow.h"
#include "./mavlink_msg_xcsoar_calculated.h"
